...
import type { PredictionInsightItem } from '../../../services/predictionAnalyticsService';
...
export const PredictionInsights: React.FC<PredictionInsightsProps> = ({ insights }) => {
  return (
    <div className="bg-gradient-to-r from-slate-900 to-purple-950 text-white rounded-2xl p-5 shadow-sm mb-8">
      <div className="flex items-center gap-2 mb-4">
        <Sparkles className="w-4 h-4 text-purple-400" />
        <h3 className="text-sm font-bold tracking-tight">AI Forecasting Insights</h3>
      </div>
