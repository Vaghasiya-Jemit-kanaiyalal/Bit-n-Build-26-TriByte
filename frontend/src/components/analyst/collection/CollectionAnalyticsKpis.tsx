...
import { CalendarCheck, CheckCircle2, Clock, Timer, TrendingUp, TrendingDown } from 'lucide-react';
import type { CollectionKpiData } from '../../../services/collectionAnalyticsService';

interface CollectionAnalyticsKpisProps {
  kpis: CollectionKpiData;
}

export const CollectionAnalyticsKpis: React.FC<CollectionAnalyticsKpisProps> = ({ kpis }) => {
  const cards = [
    {
      label: 'Planned Collections',
      value: kpis.plannedCollections.toLocaleString(),
      trend: kpis.plannedTrend,
    ...
    },
    {
      ...
      value: kpis.completedCollections.toLocaleString(),
      trend: kpis.completedTrend,
      trendText: 'pickups executed',
      icon: CheckCircle2,
    ...
    },
    {
      ...
      trend: kpis.onTimeRateTrend,
      trendText: 'SLA timeliness',
      icon: Clock,
    ...
    },
    {
      ...
      value: `${kpis.avgCollectionTimeMinutes} min`,
      trend: kpis.avgCollectionTimeTrend,
      trendText: 'per stop duration',
      icon: Timer,
...
export default CollectionAnalyticsKpis;
