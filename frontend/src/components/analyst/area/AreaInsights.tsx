...
import type { AreaInsightItem } from '../../../services/areaAnalysisService';

interface AreaInsightsProps {
  insights: AreaInsightItem[];
}

export const AreaInsights: React.FC<AreaInsightsProps> = ({ insights }) => {
  return (
    <div className="bg-gradient-to-r from-slate-900 to-emerald-950 text-white rounded-2xl p-5 shadow-sm mb-8">
      <div className="flex items-center gap-2 mb-4">
        <Sparkles className="w-4 h-4 text-emerald-400" />
        <h3 className="text-sm font-bold tracking-tight">Area Performance Insights</h3>
      </div>
