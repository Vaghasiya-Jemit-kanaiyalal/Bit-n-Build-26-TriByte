...
interface RecyclingAnalyticsHeaderProps {
  dateRange: string;
...
export const RecyclingAnalyticsHeader: React.FC<RecyclingAnalyticsHeaderProps> = ({
  dateRange,
  onDateRangeChange,
  onRefresh,
  isRefreshing = false,
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5 mb-1">
            ...
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">Recycling Analytics & Impact</h1>
          </div>
          <p className="text-xs font-semibold text-slate-500">
            Analyze waste diversion rates, recyclable material recovery purity, and environmental carbon savings.
          </p>
        </div>
...
export default RecyclingAnalyticsHeader;
