...
export const FilterDrawer: React.FC<FilterDrawerProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-white rounded-2xl shadow-2xl max-h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-200 text-xs text-slate-700"
